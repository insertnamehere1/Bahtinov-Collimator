...
{
    /// <summary>
    /// Provides an adjustment assistant specifically designed for Maksutov-Cassegrain telescopes (MCTs).
    /// Inherits functionality from the AdjustAssistantBase class.
    /// </summary>
    internal class AdjustAssistMCT : AdjustAssistBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdjustAssistMCT"/> class with the specified parent form.
        /// </summary>
        /// <param name="parent">The parent form that this assistant operates on.</param>
        public AdjustAssistMCT(Form1 parent) : base(parent)
        {
            this.Text = "Adjustment Assistant for Maksutov-Cassegrain (MCT)";
        }
        ...
        /// <summary>
        /// Draws the contents of the PictureBox, including arrows and circles 
