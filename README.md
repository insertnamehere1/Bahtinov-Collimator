...
- Click here to download SkyCal Online setup.exe [Online Setup](https://github.com/insertnamehere1/Bahtinov-Collimator/releases/download/v5.0.1.0/SkyCal-Setup.exe)
- Click here to download SkyCal Offline setup.exe [Offline Setup](https://github.com/insertnamehere1/Bahtinov-Collimator/releases/download/v5.0.1.0/SkyCal-ClickOnce-Offline-v5.0.1.0.zip)
